...
/* This class contains the functionality for the CountWordFrame class; 
 This class handles the event generated by the CountWordFrame class
...
public class CountWordApp implements ActionListener {
	
	// --- Instance variables ---
	
	// Create an object of CountWordFrame class.
	CountWordFrame test;
	
	// --- Constructor ---
	
	// Define the constructor which takes an object of CountWordFrame class as an parameter for the
	// two-way communication between the two classes.
	public CountWordApp(CountWordFrame frame) {
	...
	/*
	 * This method retrieves the text from the 'wordToFind' textfield and checks if its present in
	 * the text area, if present it displays the text word found at index and highlights the word in
	 * the textarea. If the word is not found then it displays the message 'word not found'
	 */
	...
	private void countAll() {
		...
		else { // Set the textfields with the appropriate values calculated above
